...
/**
 * Provides SCAP 1.3 specific schema/schematron items required for SCAPVal validation.
 */
public class SCAP13DataStream implements IScapDataStream {
    ...
    private static final String[] Schemas = { "classpath:xsd/nist/cpe/2.3/cpe-language_2.3.xsd",
            ...
            "classpath:xsd/nist/cpe/2.3/cpe-naming_2.3.xsd", "classpath:xsd/nist/ocil/2.0/ocil-2.0.xsd",
    ...
    public SCAP13DataStream(String id, Application.ContentType contentType) {
        ...
        this.id = id;
        this.scapVersion = SCAPVersion.V1_3;
    ...
    public LinkedList<SchematronSet> getSchematronSets() {
        ...
        try {
            ...
            SchematronSet xccdfSchematronSet
                    = new SchematronSet(xccdfSchematron, xccdfSchematronHandler, xccdfPhase, null);

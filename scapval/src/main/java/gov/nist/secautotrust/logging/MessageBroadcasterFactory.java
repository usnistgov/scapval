...
public class MessageBroadcasterFactory {
  ...
  public static MessageBroadcaster broadcaster() {
    if (broadcaster == null) {
      Class<? extends MessageBroadcaster> clazz = null;
      try {
        clazz = (Class<? extends MessageBroadcaster>) Class.forName(className);
      } catch (ClassNotFoundException e) {
        throw new RuntimeException(e);
      }
      try {
        broadcaster = clazz.newInstance();
  ...
  public static void registerBroadcaster(String className) {
    MessageBroadcasterFactory.className = className;
  }

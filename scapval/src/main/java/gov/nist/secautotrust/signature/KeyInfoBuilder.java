...
/**
 * A builder for creating a key info.
 */
public class KeyInfoBuilder {
  ...
  public KeyInfoBuilder certificate(X509Certificate cert) {
  ...
  public SigKeyInfo build() {
    DefaultSigKeyInfo keyInfo = new DefaultSigKeyInfo(publicKey, privateKey);
    keyInfo.setCerts(certificates);
    return keyInfo;
  }
}

 ...
 * not required for SCAP 1.2/1.3/1.4 versions as they implement a native data-stream approach The
 * order of these matter for some of the methods which iterates the fileSourceNameSuffix with
 * .endswith()
 */

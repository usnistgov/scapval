...
public class BatchSummaryReportGenerator {
    ...
    for (BatchFileResult r : results) {
      ...
      if (failures.isEmpty()) {
        ...
        for (FailureDetail f : failures) {
          html.append("<tr>");
          html.append("<td class=\"req-id\">").append(esc(f.requirementId)).append("</td>");
          html.append("<td>").append(esc(f.message)).append("</td>");
  ...
  private static final String CSS =
    ...
    + ".detail-table { margin: 0; box-shadow: none; border-radius: 0; }\n"
    ...
    + "  padding: 2px 6px; border-radius: 3px; display: inline-block; max-width: 600px; }\n"

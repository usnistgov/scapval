...
public class SCAP11ComponentsTest {
  ...
  @Test
  public void isValidFileNameTrue() throws Exception {
    Assert.assertEquals(SCAP11Components.isValidSCAP11FileName("cpe-oval.xml"), true);
  }

  @Test
  public void isValidFileNameFalse() throws Exception {
    Assert.assertEquals(SCAP11Components.isValidSCAP11FileName("cpe-ovals.xml"), false);
  }

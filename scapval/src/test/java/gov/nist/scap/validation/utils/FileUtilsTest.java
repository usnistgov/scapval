...
public class FileUtilsTest {
    ...
    public void getFileHash() throws Exception {
        final File datastream = new File(new URL("classpath:src/test/resources/candidates/scap-12/scap_gov.nist_USGCB-Windows-XP-firewall.xml").getFile());
        Assert.assertEquals(FileUtils.getFileHash(datastream, FileUtils.DEFAULT_HASH_ALGORITHM), "31AFB52F56F827AFE8555397D2E6302127AB715EAE9316AFA4D509C2008E6857");
    }
    ...
    public void decompressGZIPFile() throws Exception {
        final File compressedFile = new File(new URL("classpath:src/test/resources/candidates/gzip/test-content.gz").getFile());

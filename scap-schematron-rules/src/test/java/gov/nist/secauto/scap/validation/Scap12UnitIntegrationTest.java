...
/**
 * SCAP 1.2 unit integration tests with version-specific requirements.
 * Uses the SCAP 1.2 requirements definition so that requirement types
...
public class Scap12UnitIntegrationTest {
  ...
  public static List<File> paths() {
    File unitTestDir = new File("src/test/resources/unit-tests/scap-1.2/");

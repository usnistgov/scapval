...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern id="scap-general">
    ...
    <sch:rule id="scap-general-oval-generator" context="oval-def:generator">
      <sch:assert id="scap-general-oval-generator-version" test="matches(oval-com:schema_version,'^5\.(3|4|5|6|7|8|9|10(\.1)?)$')">SRC-216-1</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="scap-additional-rules">
    ...
    <sch:rule id="scap-oval-tests" context="oval-def:tests/*">
      <sch:assert flag="INFO" test="exists(document(concat($datafiles_directory,'/validation_program_oval_test_types.xml'))/test-types-collection/test_types[@style='SCAP_1.1']/test_type[@namespace eq namespace-uri(current()) and @name eq local-name(current())])" id="scap-oval-tests-validation-program-test-types">A-21-1|OVAL test <sch:value-of select="@id"/></sch:assert>
    </sch:rule>

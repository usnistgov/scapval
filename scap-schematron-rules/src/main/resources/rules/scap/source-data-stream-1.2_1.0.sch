...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern id="scap-general">
    <sch:rule id="scap-general-xccdf-benchmark" context="xccdf:Benchmark">
      ...
      <sch:assert id="scap-general-xccdf-style" test="@style eq 'SCAP_1.2'">SRC-4-1|xccdf:Benchmark <sch:value-of select="@id"/></sch:assert>
      ...
      <sch:assert id="scap-general-xccdf-metadata-populated" test="if( exists(xccdf:metadata) ) then exists(xccdf:metadata/dc:creator) and exists(xccdf:metadata/dc:publisher) and exists(xccdf:metadata/dc:contributor) and exists(xccdf:metadata/dc:source) else true()">SRC-8-1|xccdf:Benchmark <sch:value-of select="@id"/></sch:assert>
    ...
    <sch:rule id="scap-general-xccdf-check" context="xccdf:Rule/xccdf:check">
      ...
      <sch:assert id="scap-general-xccdf-check-multi-check" test="if( ancestor::xccdf:Rule[1][ends-with(@id,'security_patches_up_to_date')] ) then matches(@multi-check,'^(true|1)$') else true()">SRC-275-1|xccdf:Rule <sch:value-of select="ancestor::xccdf:Rule[1]/@id"/></sch:assert>
    ...
    <sch:rule id="scap-general-scap-content" context="scap:data-stream">
      <sch:assert id="scap-general-scap-content-every-cpe-equal-subset" test="if( function-available('java:isEqualOrSuperset') ) then (every $m in ds:checklists/ds:component-ref satisfies ((every $n in xcf:get-component($m)//xccdf:platform[not(starts-with(@idref,'#'))] satisfies some $o in ds:dictionaries/ds:component-ref satisfies some $p in xcf:get-component($o)//cpe-dict:cpe-item satisfies java:isEqualOrSuperset($n/@idref,$p/@name)) and (every $q in xcf:get-component($m)//cpe-lang:fact-ref satisfies some $r in ds:dictionaries/ds:component-ref satisfies some $s in xcf:get-component($r)//cpe-dict:cpe-item satisfies java:isEqualOrSuperset($q/@name,$s/@name)))) else true()">SRC-15-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      <sch:assert id="scap-general-xccdf-check-content-ref-patch-id-req" test="every $m in ds:checklists/ds:component-ref satisfies every $n in xcf:get-component($m)//xccdf:Rule[starts-with(@id,'xccdf_') and ends-with(@id,'_rule_security_patches_up_to_date')]//xccdf:check-content-ref[not(xcf:is-external-ref($m/cat:catalog, @href) cast as xsd:boolean)] satisfies exists(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $n/@href))//oval-def:definition[@class eq 'patch'])">SRC-169-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      ...
      <sch:assert id="scap-use-case-conf-verification-content-xccdf-req" test="if( @use-case eq 'CONFIGURATION' ) then exists(ds:checklists/ds:component-ref) else true()">SRC-236-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      <sch:assert id="scap-use-case-vul-assess-xccdf-oval-content-xccdf-req" test="if( @use-case eq 'VULNERABILITY' ) then exists(ds:checklists/ds:component-ref) else true()">SRC-242-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      ...
      <sch:assert id="scap-use-case-inventory-collection-content-xccdf-req" test="if( @use-case eq 'INVENTORY' ) then exists(ds:checklists/ds:component-ref) else true()">SRC-248-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      ...
      <sch:assert id="scap-use-case-conf-verification-benchmark-one-rule-ref-oval-ocil" test="if( @use-case eq 'CONFIGURATION' ) then every $m in ds:checklists/ds:component-ref satisfies some $n in xcf:get-component($m)//xccdf:check[matches(@system,'^(http://oval\.mitre\.org/XMLSchema/oval-definitions-5|http://scap\.nist\.gov/schema/ocil/2)$')]/xccdf:check-content-ref[not(xcf:is-external-ref($m/cat:catalog,@href) cast as xsd:boolean)] satisfies (exists(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $n/@href))//ocil:questionnaire[@id eq $n/@name]) or exists(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $n/@href))//oval-def:definition[@id eq $n/@name and @class eq 'compliance'])) else true()">SRC-262-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      <sch:assert id="scap-use-case-vul-assess-xccdf-benchmark-one-rule-ref-oval-ocil" test="if( @use-case eq 'VULNERABILITY' ) then every $m in ds:checklists/ds:component-ref satisfies some $n in xcf:get-component($m)//xccdf:check[matches(@system,'^(http://oval\.mitre\.org/XMLSchema/oval-definitions-5|http://scap\.nist\.gov/schema/ocil/2)$')]/xccdf:check-content-ref[not(xcf:is-external-ref($m/cat:catalog,@href) cast as xsd:boolean)] satisfies (exists(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $n/@href))//ocil:questionnaire[@id eq $n/@name]) or exists(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $n/@href))//oval-def:definition[@id eq $n/@name and @class eq 'vulnerability'])) else true()">SRC-265-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      ...
      <sch:assert id="scap-general-scap-content-resolve-to-comp-ref" test="every $m in ds:checklists/ds:component-ref satisfies every $n in xcf:get-component($m)//xccdf:Rule//xccdf:check-content-ref satisfies exists(xcf:get-component-ref($m/cat:catalog, $n/@href))">SRC-31-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      <sch:assert id="scap-general-scap-content-use-case" test="matches(@use-case,'^(CONFIGURATION|VULNERABILITY|INVENTORY|OVAL_ONLY)$')">SRC-324-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      ...
      <sch:assert id="scap-general-xccdf-rule-value-binding-type-3" test="every $m in ds:checklists/ds:component-ref satisfies every $n in xcf:get-component($m)//xccdf:check-export satisfies ( not(matches($n/ancestor::xccdf:Benchmark//xccdf:Value[@id eq $n/@value-id]/@type, '^string$')) or (every $o in $n/following-sibling::xccdf:check-content-ref satisfies matches(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $o/@href))//*[@id eq $n/@export-name]/@datatype, '^(string|evr_string|version|ios_version|fileset_revision|binary)$')))">SRC-38-3|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      <sch:assert id="scap-general-xccdf-rule-value-binding-type-2" test="every $m in ds:checklists/ds:component-ref satisfies every $n in xcf:get-component($m)//xccdf:check-export satisfies ( not(matches($n/ancestor::xccdf:Benchmark//xccdf:Value[@id eq $n/@value-id]/@type, '^boolean$')) or (every $o in $n/following-sibling::xccdf:check-content-ref satisfies matches(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $o/@href))//*[@id eq $n/@export-name]/@datatype, '^boolean$')))">SRC-38-2|scap:data-stream <sch:value-of select="@id"/></sch:assert>
      <sch:assert id="scap-general-xccdf-rule-value-binding-type-1" test="every $m in ds:checklists/ds:component-ref satisfies every $n in xcf:get-component($m)//xccdf:check-export satisfies ( not(matches($n/ancestor::xccdf:Benchmark//xccdf:Value[@id eq $n/@value-id]/@type, '^number$')) or (every $o in $n/following-sibling::xccdf:check-content-ref satisfies matches(xcf:get-component(xcf:get-component-ref($m/cat:catalog, $o/@href))//*[@id eq $n/@export-name]/@datatype, '^(int|float)$')))">SRC-38-1|scap:data-stream <sch:value-of select="@id"/></sch:assert>
    ...
    <sch:rule id="scap-general-xccdf-check-content-ref" context="xccdf:check-content-ref">
      <sch:assert id="scap-general-xccdf-check-content-ref-name-omit-patch" test="if( exists(ancestor::xccdf:Rule[1][starts-with(@id,'xccdf_') and ends-with(@id,'_rule_security_patches_up_to_date')]) ) then not(exists(@name)) else true()">SRC-171-1|xccdf:Rule <sch:value-of select="ancestor::xccdf:Rule/@id"/></sch:assert>
    </sch:rule>
    ...
    <sch:rule id="scap-general-oval-def" context="oval-def:definition">
      ...
      <sch:assert id="scap-general-oval-def-patch-ref-cve" test="if( @class eq 'patch' ) then exists(current()//oval-def:reference[matches(@source,'^(CVE|http://cve.mitre.org)$')]) else true()">SRC-211-1|oval-def:definition <sch:value-of select="@id"/></sch:assert>
    ...
    <sch:rule id="scap-general-oval-generator" context="oval-def:generator">
      <sch:assert id="scap-general-oval-generator-version" test="matches(oval-com:schema_version,'^5\.(3|4|5|6|7|8|9|10)$')">SRC-216-1</sch:assert>
    </sch:rule>
    ...
    <sch:rule id="scap-general-xccdf-version" context="xccdf:version">
      <sch:assert id="scap-general-xccdf-version-time-attribute-req" test="exists(@time)">SRC-3-2</sch:assert>
      <sch:assert id="scap-general-xccdf-version-update-req" test="exists(@update)">SRC-341-1</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="scap-additional-rules">
    ...
    <sch:rule id="scap-cce-check-rule-1" context="xccdf:ident">
      ...
      <sch:assert flag="ERROR" test="if(@system eq 'http://cce.mitre.org' or @system eq 'CCE') then matches(., '^CCE-\d+-\d$') else true()" id="scap-cce-check-assert-2">A117-1|<sch:value-of select="."/></sch:assert>
    ...
    <!--        
        ...
        id="scap-xccdf-profile-check-asset">A20|xccdf:Benchmark <sch:value-of select="@id"/></sch:assert>
        </sch:rule>
    -->
    <sch:rule id="scap-oval-tests" context="oval-def:tests/*">
      <sch:assert flag="INFO" test="exists(document(concat($datafiles_directory,'/validation_program_oval_test_types.xml'))/test-types-collection/test_types[@style='SCAP_1.2']/test_type[@namespace eq namespace-uri(current()) and @name eq local-name(current())])" id="scap-oval-tests-validation-program-test-types">A-21-1|OVAL test <sch:value-of select="@id"/></sch:assert>
    </sch:rule>

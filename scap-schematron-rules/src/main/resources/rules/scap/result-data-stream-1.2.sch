...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern id="scap-result-general">
    ...
    <sch:rule id="scap-result-general-xccdf-test-result" context="xccdf:TestResult">
      ...
      <sch:assert id="scap-result-general-xccdf-test-result-benchmark-id-req" test="exists(xccdf:benchmark[exists(@id)])">RES-253-1</sch:assert>
    ...
    <sch:rule id="scap-result-general-report-collection" context="arf:asset-report-collection">
      ...
      <sch:assert id="scap-result-general-arf-rel-namespace" test="every $m in current()/rc:relationships/rc:relationship satisfies($m[resolve-QName(@type,.) != QName('http://scap.nist.gov/vocabulary/arf/relationships/1.0#','isAbout')])">RES-304-2</sch:assert>
	    <sch:assert id="scap-result-general-report-collection-report-request-not-included" test="exists(.//arf:report-request)">A-24-1|arf:asset-report-collection <sch:value-of select="@id"/></sch:assert>

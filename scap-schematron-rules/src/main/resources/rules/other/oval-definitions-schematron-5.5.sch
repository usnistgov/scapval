...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsd="http://www.w3.org/2001/XMLSchema" queryBinding="xslt">
    ...
    <sch:ns prefix="pix-def" uri="http://oval.mitre.org/XMLSchema/oval-definitions-5#pix"/>
    ...
    <sch:pattern id="entityobjectbaserules">
        <sch:rule context="oval-def:objects/*/*[@var_ref]">
            <sch:assert test="@var_check">
                <sch:value-of select="../@id"/> - a var-ref has been supplied for the <sch:value-of select="name()"/> entity so a var_check should also be provided</sch:assert>
        </sch:rule>
    </sch:pattern>
    ...
    <sch:pattern id="esxpatchobjpatch_number">
        <sch:rule context="esx-def:patch_object/esx-def:patch_number">
            <sch:assert test="@datatype='int'">
                <sch:value-of select="../@id"/> - datatype attribute for the patch_number entity of a patch_object should be 'int'</sch:assert>
        </sch:rule>
    </sch:pattern>
    ...
    <sch:pattern id="wuaupdatesearcherstesearchcriteria">
        <sch:rule context="win-def:wuaupdatesearcher_state/win-def:search_criteria">
            <sch:assert test="not(@datatype) or @datatype='string'">
                <sch:value-of select="../@id"/> - datatype attribute for the search_criteria entity of a wuaupdatesearcher_state should be 'string'</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern id="wuaupdatesearchersteupdateid">
        <sch:rule context="win-def:wuaupdatesearcher_state/win-def:update_id">
            <sch:assert test="not(@datatype) or @datatype='string'">
                <sch:value-of select="../@id"/> - datatype attribute for the update_id entity of a wuaupdatesearcher_state should be 'string'</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:diagnostics/>
</sch:schema>

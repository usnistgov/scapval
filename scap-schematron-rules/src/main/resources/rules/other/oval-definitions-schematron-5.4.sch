...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    ...
    <!-- H. Owen - 12/4/2009 - Removed queryBinding="xslt2" from root in order to process as XPath 1.0 in order avoid
        XPath exception on floor() function when current element processed is not a node.
    -->

...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <sch:pattern id="oval-res_directives_include_oval_definitions">
                                        ...
                                        <sch:rule context="oval-res:oval_results/oval-res:directives[@include_source_definitions = false()]">
   ...
   <sch:pattern id="oval-res_system">
                         <sch:rule context="oval-res:system[oval-res:tests]">
                              ...
                              <sch:assert test="ancestor-or-self::oval-res:oval_results/oval-res:directives/*[@reported=true()][@content='full' or not(@content)]                                                 or ancestor-or-self::oval-res:oval_results/oval-res:directives/*[@reported=true() and not(@content)]                                                 or ancestor-or-self::oval-res:oval_results/oval-res:class_directives/*[@reported=true()][@content='full' or not(@content)]                                                 or ancestor-or-self::oval-res:oval_results/oval-res:class_directives/*[@reported=true()and not(@content)]">
                         ...
                         <sch:rule context="oval-res:system[not(oval-res:tests)]">
                              ...
                              <sch:assert test="not(oval-res:oval_results/oval-res:directives/*[@reported=true()][@content='full' or not(@content)])                                                  and not(ancestor-or-self::oval-res:oval_results/oval-res:directives/*[@reported=true() and not(@content)])                                                 and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives/*[@reported=true()][@content='full' or not(@content)])                                                 and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives/*[@reported=true()and not(@content)])">
   ...
   <sch:pattern id="oval-res_directives">
                         ...
                         <sch:rule context="oval-res:definition[@result='true' and oval-res:criteria]">
                              ...
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_true/@reported=true())                                    and not(oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_true/@reported=true())">
                         ...
                         <sch:rule context="oval-res:definition[@result='true' and not(oval-res:criteria)]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_true/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_true/@reported=true())">
                                   <sch:value-of select="@definition_id"/> - definitions with a result of TRUE should not be included (see directives)
                              </sch:assert>
                         ...
                         <sch:rule context="oval-res:definition[@result='false' and oval-res:criteria]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_false/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_false/@reported=true())">
                         ...
                         <sch:rule context="oval-res:definition[@result='unknown' and oval-res:criteria]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_unknown/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_unknown/@reported=true())">
                         ...
                         <sch:rule context="oval-res:definition[@result='error' and oval-res:criteria]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_error/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_error/@reported=true())">
                         ...
                         <sch:rule context="oval-res:definition[@result='error' and not(oval-res:criteria)]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_error/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_unknown/@reported=true())">
                                   <sch:value-of select="@definition_id"/> - definitions with a result of ERROR should not be included (see directives)
                              </sch:assert>
                         ...
                         <sch:rule context="oval-res:definition[@result='not evaluated' and oval-res:criteria]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_not_evaluated/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_not_evaluated/@reported=true())">
                         ...
                         <sch:rule context="oval-res:definition[@result='not applicable' and oval-res:criteria]">
                              <sch:assert test="((ancestor-or-self::oval-res:oval_results/oval-res:directives/oval-res:definition_not_applicable/@reported=true())                                    and not(ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (ancestor-or-self::oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_not_applicable/@reported=true())">
   ...
   <sch:pattern id="oval-def_definition_entity_rules">
            ...
            <sch:value-of select="../@id"/> - a var_ref has been supplied for the <sch:value-of select="name()"/> entity so a var_check must also be provided</sch:report>
                    </sch:rule>

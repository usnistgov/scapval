 ...
 */
package gov.nist.scap.validation.requirements.decima;

import gov.nist.decima.core.assessment.Assessment;
import gov.nist.decima.core.assessment.AssessmentException;
import gov.nist.decima.core.assessment.result.AssessmentResultBuilder;
import gov.nist.decima.core.assessment.result.TestState;
import gov.nist.decima.xml.assessment.schematron.SVRLHandler;
import gov.nist.decima.xml.assessment.schematron.SingleDerivedRequirementSchematronHandler;
...
public class ComponentSchematronHandler extends SingleDerivedRequirementSchematronHandler {
  ...
  public SVRLHandler newSVRLHandler(Assessment<? extends XMLDocument> assessment, XMLDocument assessedDocument,
    ...
    assessmentResultBuilder.assignTestStatus(assessment, assessedDocument, this.getDerivedRequirementId(),
        TestState.TESTED);
    return new ComponentResultGeneratingSVRLHandler(getDerivedRequirementId(), assessment, assessedDocument,
